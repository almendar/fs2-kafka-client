...
object producing {
  ...
  /**
    ...
    */
  def produce[F[_], K, V](settings: ProducerSettings,
  ...
  /**
    ...
    */
  def producerStream[F[_], K, V](settings: ProducerSettings,
                                 keySerializer: Serializer[K],
                                 valueSerializer: Serializer[V])(
      implicit F: Sync[F]): Stream[F, Producer[K, V]] =
    Stream.bracket(
      F.delay(
        new KafkaProducer[K, V](settings.nativeSettings.asJava,
                                keySerializer,
                                valueSerializer))
    )(p => F.delay(p.close))
  ...
  /**
    ...
    */
  def produceRecord[F[_], K, V](
      producer: Producer[K, V],
      record: ProducerRecord[K, V])(implicit F: Async[F]): F[RecordMetadata] =
  ...
  /**
    ...
    */
  def produceRecordWithBatching[F[_], K, V](producer: Producer[K, V],
  ...
  /**
    ...
    * as is in the output.
    */
  def produceRecordBatch[F[_], K, V, P](
      producer: Producer[K, V],
  ...
  /**
    ...
    */
  def subscribedProduce[F[_], K, V, B](
      p: Producer[K, V],
      topic: Topic[F, B],
